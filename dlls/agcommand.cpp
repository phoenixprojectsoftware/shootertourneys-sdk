...
{
  "sv_creative_max_spectators <0-32> - Max spectators allowed.",
  "sv_creative_spec_enable_disable<0/1> - Allow players to disable tracking in spectator.",
  "sv_creative_pure <0/1> - 0 spike check and simple variable checks, 1 harder variable check.",
  "sv_creative_match_running <0/1> - Tells if a match is running.",
  "sv_creative_allow_vote <0/1> - Allow any vote.",
  "sv_creative_vote_setting <0/1> - Vote ag_xxx and mp_xxx settings.",
  "sv_creative_vote_gamemode <0/1> - Allow gamemode switching.",
  "sv_creative_vote_kick <0/1> - Allow voting a kick.",
  "sv_creative_vote_admin <0/1> - Allow voting an admin.",
  "sv_creative_vote_map <0/1> - Allow map voting.",
  "sv_creative_vote_mp_timelimit_low <0-999> - Lowest timelimit to vote on.",
  "sv_creative_vote_mp_timelimit_high <0-999> - Highest timelimit to vote on.",
  "sv_creative_vote_mp_fraglimit_low <0-999> - Lowest fraglimit to vote on.",
  "sv_creative_vote_mp_fraglimit_high <0-999> - Highest fraglimit to vote on.",
  "sv_creative_floodmsgs <4> - Flood messages to tolerate. 0 will deactive it.",
  "sv_creative_floodpersecond <4> - Flood messages per second.",
  "sv_creative_floodwaitdelay <10> - Flood penalty timer.",
  "sv_creative_show_gibs <0/1> - Show dead bodies.",
  "sv_creative_spawn_volume <0-1> - The spawn sound volume.",
  "sv_creative_player_id <5> - Player id show to other players. In seconds.",
  "sv_creative_auto_admin <1> - Give auto admin to admins in admin list.",
  "sv_creative_lj_timer <0-999> - Countdown seconds for long jump. 0 turns it off.",
  "sv_creative_wallgauss <0/1> - Wallgauss on/off. On is for the weak :)",
  "sv_creative_headshot <1-3> - Set power of headshot. Normally 3.",
  "sv_creative_blastradius <1> - Blast radius for explosions. Normally 1",
  "sv_creative_allowed_gamemodes <ffa;tdm> - Allowed gamemodes, could be any off ffa;tdm;arena;arcade;sgbow;instagib",
};
